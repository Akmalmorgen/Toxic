...
REVEAL_AUTO_MSG = (
    "Привет! Я {name}, из бота 𝐍𝐞𝐱𝐭.. — хочу познакомиться"
)
...
UserRow = sqlite3.Row or dict or type(None)
...
def resolve_user_ref(text):
    ...
    if not uname:
        return None
    row = conn.execute(
        "SELECT tg_id FROM users WHERE LOWER(username)=?",
        (uname,),
    ).fetchone()
...
def user_mention(user_row):
    ...
    return (
        f'<a href="tg://user?id={user_row["tg_id"]}">'
...
def has_forbidden_contacts(text):
    ...
    if re.search(r"@[a-z][a-z0-9_]{2,}", low):
        return True
    if re.search(
        r"https?://|www\.|t\.me|telegram\.me|telegram\.dog|joinchat|tg://",
        low,
    ):
        return True
    if re.search(
        r"\b[a-z0-9][a-z0-9-]*\.(com|ru|uz|net|org|io|me|info|biz|tv|"
        r"app|link|site|online|club|store|xyz|kz)\b",
        low,
    ):
        return True
    if re.search(
        r"\b(instagram|insta|tiktok|youtube|youtu|whatsapp|watsap|vatsap|"
        r"facebook|snapchat|discord|onlyfans|vkontakte|тикток|инстаграм|"
        r"ютуб|ватсап|вотсап)\b",
        low,
    ):
        return True
...
BTN = {
    ...
    "➕ Добавить пакет коинов": (
        "➕ Coin paket qo'shish",
        "➕ Add coin package",
    ),
    "🗑 Удалить пакет коинов": (
        "🗑 Coin paketni o'chirish",
        "🗑 Delete coin package",
    ),
    "🛡 Модерка на неделю": (
        "🛡 Bir haftalik moder",
        "🛡 Moderator for a week",
    ),
...
T.update({
    ...
    "link_menu": {
        "ru": "👇 Действие на клавиатуре",
        "uz": "👇 Klaviaturadan amalni tanlang",
        "en": "👇 Choose on keyboard",
    },
    "link_show": {
        "ru": (
            "🤫 <b>Ваша ссылка</b>\n"
    ...
    "link_no_link": {
        "ru": "🔗 Придумайте код (до 10 символов):",
        "uz": "🔗 Kod kiriting (10 belgigacha):",
        "en": "🔗 Create code (up to 10):",
    },
    "link_change": {
        "ru": "✏️ Новый код (до 10). Старая ссылка живёт ещё 24 ч.",
        "uz": "✏️ Yangi kod (10). Eski 24 soat ishlaydi.",
        "en": "✏️ New code (10). Old works 24h.",
    },
    "link_invalid": {
        "ru": "❌ До 10 символов (латиница, цифры, «-», «_»):",
        "uz": "❌ 10 belgigacha:",
        "en": "❌ Up to 10 chars:",
    },
    "link_taken": {
        "ru": "❌ Занят, попробуйте другой:",
        "uz": "❌ Band:",
        "en": "❌ Taken:",
    },
    "link_limit": {
        "ru": "⏳ Через {days} дн. Или купи Premium",
        "uz": "⏳ {days} kundan keyin. Yoki Premium",
        "en": "⏳ In {days} days. Or buy Premium",
    },
    "btn_share": {
        "ru": "🔗 Поделиться",
        "uz": "🔗 Ulashish",
    ...
    "share_text": {
        "ru": "Напиши мне анонимно",
        "uz": "Menga anonim yozing",
        "en": "Send me anonymously",
    },
    "anon_what_send": {
        "ru": "❓ Что отправить?",
        "uz": "❓ Nima yuborish?",
    ...
    "anon_write_prompt": {
        "ru": "✍️ Напишите {label} (текст или голос):",
        "uz": "✍️ {label}ni yozing:",
        "en": "✍️ Write {label}:",
    },
    "anon_label_question": {
        "ru": "вопрос",
    ...
    "anon_limit": {
        "ru": "⚠️ Лимит {n}/сутки. Premium снимает",
        "uz": "⚠️ {n}/kun. Premium olib tashlaydi",
        "en": "⚠️ Limit {n}/day. Premium removes",
    },
    "anon_vip_media": {
        "ru": "📷 Только Premium. Отправь текст или голос.",
        "uz": "📷 Faqat Premium.",
        "en": "📷 Premium only.",
    },
    "anon_formats": {
    ...
    "anon_own_link": {
        "ru": "❌ Это ваша ссылка",
        "uz": "❌ Bu sizning havolangiz",
        "en": "❌ Your own link",
    },
    "anon_banned": {
        "ru": "⛔ Временно нельзя писать",
        "uz": "⛔ Vaqtincha yoza olmaysiz",
        "en": "⛔ Temporarily can't write",
    },
    "anon_deleted_notice": {
        "ru": "🗑 Собеседник удалил сообщение",
        "uz": "🗑 Suhbatdosh o'chirdi",
        "en": "🗑 Sender deleted message",
    },
    "anon_hdr_question": {
        "ru": "📩 <b>Анонимный вопрос</b>",
        "uz": "📩 <b>Anonim savol</b>",
        "en": "📩 <b>Anonymous question</b>",
    },
    "anon_hdr_valentine": {
        "ru": "💌 <b>Анонимная валентинка</b>",
        "uz": "💌 <b>Anonim valentinka</b>",
        "en": "💌 <b>Anonymous valentine</b>",
    },
    "anon_hdr_reply": {
        "ru": "💬 <b>Вам ответили</b>",
        "uz": "💬 <b>Javob berishdi</b>",
        "en": "💬 <b>Reply received</b>",
    },
    "anon_hdr_new": {
    ...
    "del_both": {
        "ru": "🗑 Удалено у обоих",
        "uz": "🗑 Ikkalasida o'chirildi",
        "en": "🗑 Deleted for both",
    },
    "del_only_me": {
        "ru": "🗑 Удалено только у тебя",
        "uz": "🗑 Faqat sizda",
        "en": "🗑 Only for you",
    },
    "del_stale": {
        "ru": "⚠️ Устарело — только у тебя",
        "uz": "⚠️ Eskirgan — faqat sizda",
        "en": "⚠️ Stale — only for you",
    },
    "report_choose": {
        "ru": "🚩 Причина:",
        "uz": "🚩 Sabab:",
    ...
    "report_confirmed_user": {
        "ru": "✅ Подтверждена. Пользователь не сможет писать {days} дн.",
        "uz": "✅ Tasdiqlandi. {days} kun yoza olmaydi.",
        "en": "✅ Confirmed. User can't write for {days} days.",
    },
    "report_confirmed_forever": {
        "ru": "✅ Подтверждена. Пользователь <b>никогда</b> не напишет.",
        "uz": "✅ Tasdiqlandi. <b>Hech qachon</b>.",
        "en": "✅ Confirmed. User can <b>never</b> write.",
    },
    ...
    "report_banned_msg": {
        "ru": "✅ <b>{name}</b> забанен #{rid}",
        "uz": "✅ <b>{name}</b> ban #{rid}",
        "en": "✅ <b>{name}</b> banned #{rid}",
    },
    "report_unbanned_msg": {
        "ru": "✅ <b>{name}</b> разбанен #{rid}",
        "uz": "✅ <b>{name}</b> unban #{rid}",
        "en": "✅ <b>{name}</b> unbanned #{rid}",
    },
    "report_rejected_msg": {
        "ru": "❌ Жалоба #{rid} отклонена",
        "uz": "❌ Shikoyat #{rid}",
        "en": "❌ Report #{rid} rejected",
    },
    "you_were_banned": {
        "ru": "⚠️ На вас жалоба — {days} дн. нельзя писать этому юзеру",
        "uz": "⚠️ Sizga shikoyat — {days} kun",
        "en": "⚠️ You were reported — {days} days",
    },
    "you_were_banned_forever": {
        "ru": "🚫 Вы <b>навсегда</b> заблокированы",
        "uz": "🚫 <b>Abadiy</b> bloklandingiz",
        "en": "🚫 <b>Permanently</b> blocked",
    },
    "you_were_unbanned": {
        "ru": "✅ Вас разбанили",
        "uz": "✅ Unban",
    ...
    "no_contacts": {
        "ru": "⛔ Ссылки, @, номера, ID и соцсети запрещены",
        "uz": "⛔ Havola, @, raqam, ID taqiqlangan",
        "en": "⛔ Links, @, numbers, IDs banned",
    },
    "cant_ban_staff": {
        "ru": "🛡 Нельзя забанить админа/модера. Жалоба отклонена",
        "uz": "🛡 Admin/moderni bloklab bo'lmaydi",
        "en": "🛡 Can't ban admin/mod",
    },
    "staff_only": {
        "ru": "🛡 Только для модерации",
        "uz": "🛡 Faqat moderatorlar",
        "en": "🛡 Moderation only",
    },
    "admin_only": {
    ...
    "super_admin_only": {
        "ru": "🔒 Только для главного админа",
        "uz": "🔒 Bosh admin",
        "en": "🔒 Super admin only",
    },
    "sub_to_delete_short": {
        "ru": (
            "🔒 <b>Подпишись чтобы удалить</b>\n"
            "Нажми кнопку → подпишись → «Проверить»"
        ),
        "uz": "🔒 <b>Obuna bo'ling</b>",
        "en": "🔒 <b>Subscribe</b>",
    },
    "btn_check_sub": {
        "ru": "🔍 Проверить",
    ...
    "subgate_start": {
        "ru": (
            "🔒 <b>Подпишись чтобы пользоваться</b>\n"
            "━━━━━━━━━━━━━━━━━━━━\n"
            "Нажми кнопку → подпишись → «Проверить»"
        ),
        "uz": "🔒 <b>Obuna bo'ling</b>",
        "en": "🔒 <b>Subscribe to use</b>",
    },
    "sub_not_found": {
    ...
    "roulette_already_chat": {
        "ru": "⚠️ Вы уже в чате",
        "uz": "⚠️ Siz chatsiz",
        "en": "⚠️ Already in chat",
    },
    "roulette_stop": {
        "ru": "⏹️ Поиск отменён",
        "uz": "⏹️ Bekor qilindi",
        "en": "⏹️ Search cancelled",
    },
    "roulette_left": {
        "ru": "🚪 Собеседник покинул чат",
        "uz": "🚪 Suhbatdosh chiqdi",
        "en": "🚪 Partner left",
    },
    "session_not_found": {
    ...
    "search_still": {
        "ru": "⏳ Всё ещё ищем…\nУже <b>{min}</b> мин.",
        "uz": "⏳ Hali qidirilmoqda…\n<b>{min}</b> daqiqa.",
        "en": "⏳ Still looking…\n<b>{min}</b> min.",
    },
    "search_timeout": {
        "ru": "⏹️ <b>Поиск остановлен</b> — за {min} мин не нашли",
        "uz": "⏹️ <b>To'xtatildi</b> — {min} daqiqada topilmadi",
        "en": "⏹️ <b>Stopped</b> — no match in {min} min",
    },
    "roulette_found": {
        "ru": (
            ...
            "<i>Пиши первым!</i>\n"
            "<blockquote>"
            "🤫 Анонимно · фото, голосовые, стикеры\n"
            "«Далее» — другой · «Стоп» — выйти"
            "</blockquote>"
        ),
        "uz": (
    ...
    "shop_vip_note": {
        "ru": "👑 Цены с Premium-скидкой −20%",
        "uz": "👑 Premium chegirma −20%",
        "en": "👑 Premium discount −20%",
    },
    "item_unavailable": {
        "ru": "❌ Товар недоступен",
        "uz": "❌ Mavjud emas",
    ...
    "price_vip": {
        "ru": "<b>{price}</b> (обычно {orig})",
        "uz": "<b>{price}</b> (odatda {orig})",
        "en": "<b>{price}</b> (usually {orig})",
    },
    "purchase_coins": {
        "ru": "✅ Начислено <b>{amt}</b>",
        "uz": "✅ <b>{amt}</b> qo'shildi",
        "en": "✅ <b>{amt}</b> added",
    },
    "purchase_vip": {
        "ru": "✅ Premium на <b>{days}</b> дн.",
        "uz": "✅ Premium <b>{days}</b> kun",
        "en": "✅ Premium for <b>{days}</b> days",
    },
    "purchase_manual": {
        "ru": "✅ Покупка! Админ свяжется",
        "uz": "✅ Xarid! Admin bog'lanadi",
        "en": "✅ Purchase! Admin will contact",
    },
    "stars_unavailable": {
        "ru": "⭐ Покупка коинов недоступна",
        "uz": "⭐ Coin sotib olish yo'q",
        "en": "⭐ Buying coins unavailable",
    },
    "stars_pick_pkg": {
        "ru": "💎 Выбери пакет",
        "uz": "💎 Paketni tanlang",
    ...
    "stars_buy_confirm": {
        "ru": "⭐ «<b>{title}</b>» ({coins}💰) за <b>{stars} ⭐</b>?",
        "uz": "⭐ «<b>{title}</b>» <b>{stars} ⭐</b>?",
        "en": "⭐ Buy «<b>{title}</b>» for <b>{stars} ⭐</b>?",
    },
    "stars_invoice_sent": {
        "ru": "💳 Счёт выставлен",
        "uz": "💳 Hisob-faktura",
    ...
    "stars_paid": {
        "ru": "🔥 Начислено <b>{coins}</b>",
        "uz": "🔥 <b>{coins}</b> qo'shildi",
        "en": "🔥 <b>{coins}</b> added",
    },
    "stars_title": {
        "ru": "⭐ <b>Коины за Stars</b>\nВыбери пакет",
        "uz": "⭐ <b>Stars uchun coin</b>",
        "en": "⭐ <b>Buy coins with Stars</b>",
    },
    "msg_not_found": {
        "ru": "❌ Не найдено",
        "uz": "❌ Topilmadi",
    ...
    "reveal_desc": {
        "ru": "Узнай кто отправил",
        "uz": "Kim yuborganini biling",
        "en": "Find out who sent",
    },
    "reveal_result": {
        "ru": (
            "👁 <b>Раскрыт!</b>\n"
    ...
    "reveal_only_recipient": {
        "ru": "🔒 Только получатель",
        "uz": "🔒 Faqat qabul qiluvchi",
        "en": "🔒 Only recipient",
    },
    "referral_screen": {
        "ru": (
    ...
    "ref_share_text": {
        "ru": "Залетай в анонимный бот! 🎁",
        "uz": "Anonim botga kir! 🎁",
        "en": "Join the anonymous bot! 🎁",
    },
    "ref_claim_vip_btn": {
        "ru": "👑 Premium бесплатно",
        "uz": "👑 Bepul Premium",
        "en": "👑 Free Premium",
    },
    "ref_claim_moder_btn": {
        "ru": "🛡 Модерка на неделю",
        "uz": "🛡 Bir haftalik moder",
        "en": "🛡 Mod for a week",
    },
    "ref_need_more": {
        "ru": (
            "❌ Нужно ещё: {n}\n"
            "У тебя: {have}/{need}\n"
            "⚠️ Считаются только создавшие свою ссылку"
        ),
        "uz": "❌ Yana: {n}\nSizda: {have}/{need}",
        "en": "❌ Need more: {n}\nYou have: {have}/{need}",
    },
    "ref_vip_granted": {
        "ru": "🎉 <b>Premium на {days} дней!</b>",
        "uz": "🎉 <b>Premium {days} kun!</b>",
        "en": "🎉 <b>Premium for {days} days!</b>",
    },
    "ref_moder_granted": {
        "ru": "🎉 <b>Модерка на {days} дней</b> за {need} друзей!",
        "uz": "🎉 <b>Moder {days} kun</b> — {need} do'st!",
        "en": "🎉 <b>Moder for {days} days</b> — {need} friends!",
    },
    "ref_info_alert": {
        "ru": "ℹ️ За друга: {n} (Premium — {v})",
        "uz": "ℹ️ Do'st: {n} (Premium — {v})",
        "en": "ℹ️ Per friend: {n} (Premium — {v})",
    },
    "link_reward": {
        "ru": "🎁 Бонус за активность: +{coins}\nВсего: {n}",
        "uz": "🎁 Bonus: +{coins}\nJami: {n}",
        "en": "🎁 Activity bonus: +{coins}\nTotal: {n}",
    },
    "ref_menu_hint": {
        "ru": "👥 Меню «Пригласить»",
        "uz": "👥 «Taklif» menyusi",
    ...
    "ref_friend_joined": {
        "ru": "🎉 По вашей ссылке друг! +{reward}",
        "uz": "🎉 Do'st keldi! +{reward}",
        "en": "🎉 Friend joined! +{reward}",
    },
    "ref_welcome_bonus": {
        "ru": "🎁 <b>Добро пожаловать!</b> Подарок <b>+{n}</b>",
        "uz": "🎁 <b>Xush kelibsiz!</b> <b>+{n}</b>",
        "en": "🎁 <b>Welcome!</b> Gift <b>+{n}</b>",
    },
    "ref_progress_title": {
        "ru": "📊 <b>Прогресс:</b>",
        "uz": "📊 <b>Progress:</b>",
    ...
    "ref_coins_refunded": {
        "ru": "⚠️ Друг заблокировал — <b>{n}</b> списаны",
        "uz": "⚠️ Blokladi — <b>{n}</b> qaytarildi",
        "en": "⚠️ Friend blocked — <b>{n}</b> deducted",
    },
    "vip_daily_bonus": {
        "ru": "🎁 Daily бонус: +{n}",
        "uz": "🎁 Kunlik bonus: +{n}",
    ...
    "moder_form_gender": {
        "ru": "🛡 <b>Анкета модера.</b>\n⚧ Пол?",
        "uz": "🛡 <b>Moder anketasi.</b>\n⚧ Jins?",
        "en": "🛡 <b>Moder app.</b>\n⚧ Gender?",
    },
    "moder_form_age": {
        "ru": "🎂 Возраст?",
    ...
    "moder_form_cancelled": {
        "ru": "↩️ Отменено. Коины ({price}) возвращены",
        "uz": "↩️ Bekor. Coinlar ({price})",
        "en": "↩️ Cancelled. Coins ({price}) refunded",
    },
    "moder_form_sent": {
        "ru": "📨 Отправлено администратору",
        "uz": "📨 Adminga yuborildi",
        "en": "📨 Sent to admin",
    },
    "moder_granted_user": {
        "ru": "🛡 Вам выдан модер!",
        "uz": "🛡 Moder berildi!",
        "en": "🛡 Moderator granted!",
    },
    "moder_granted_shop": {
        "ru": "🛡 <b>Вы Модер!</b> 👑\nБонус: @ToxIc_0707",
        "uz": "🛡 <b>Moder!</b> 👑",
        "en": "🛡 <b>You're a Moder!</b> 👑",
    },
    "moder_rejected_user": {
        "ru": "❌ Заявка отклонена. Коины ({coins}) возвращены",
        "uz": "❌ Rad. Coinlar ({coins})",
        "en": "❌ Rejected. Coins ({coins}) refunded",
    },
    "moder_taken_user": {
        "ru": "🛡 Роль снята",
        "uz": "🛡 Olib tashlandi",
    ...
    "moder_rejected_staff": {
        "ru": "❌ Отказано, возврат",
        "uz": "❌ Rad, qaytarish",
        "en": "❌ Rejected, refunded",
    },
    "mod_message": {
        "ru": "📨 <b>От модера {name}:</b>\n{text}",
        "uz": "📨 <b>{name}:</b>\n{text}",
        "en": "📨 <b>From mod {name}:</b>\n{text}",
    },
    "admin_vip_menu": {
        "ru": "👑 <b>Premium по ID</b>",
        "uz": "👑 <b>ID bo'yicha Premium</b>",
        "en": "👑 <b>Premium by ID</b>",
    },
    "vip_ask_id": {
        "ru": "🆔 Введите tg_id или @username:",
        "uz": "🆔 tg_id yoki @username:",
        "en": "🆔 Enter tg_id or @username:",
    },
    "vip_ask_days": {
        "ru": "📅 На сколько дней?",
        "uz": "📅 Necha kun?",
    ...
    "vip_days_number": {
        "ru": "🔢 Положительное число дней:",
        "uz": "🔢 Musbat kun:",
        "en": "🔢 Positive days:",
    },
    "vip_user_not_found": {
        "ru": "❌ Не найден. Введите ID или @:",
        "uz": "❌ Topilmadi. ID yoki @:",
        "en": "❌ Not found. Enter ID or @:",
    },
    "vip_granted_admin": {
        "ru": "✅ Premium <code>{id}</code> на {days} дн.",
        "uz": "✅ <code>{id}</code> {days} kun.",
        "en": "✅ Premium <code>{id}</code> for {days}d.",
    },
    "vip_taken_admin": {
        "ru": "✅ Premium снят <code>{id}</code>",
        "uz": "✅ <code>{id}</code> olib tashlandi",
        "en": "✅ Premium removed <code>{id}</code>",
    },
    "vip_granted_user": {
        "ru": "👑 <b>Вам Premium на {days} дней!</b>",
        "uz": "👑 <b>{days} kun Premium!</b>",
        "en": "👑 <b>You got Premium for {days} days!</b>",
    },
    "vip_taken_user": {
        "ru": "👑 Premium снят",
        "uz": "👑 Premium olib tashlandi",
        "en": "👑 Premium removed",
    },
    "vip_bulk_menu_title": {
        "ru": "🎯 <b>Массовый Premium — {target}</b>",
        "uz": "🎯 <b>{target}</b>",
        "en": "🎯 <b>Bulk Premium — {target}</b>",
    },
    "vip_bulk_revoke_done": {
        "ru": "✅ Снят у <b>{target}</b> ({count})",
        "uz": "✅ <b>{target}</b> ({count})",
        "en": "✅ Revoked <b>{target}</b> ({count})",
    },
    "vip_bulk_ask_days": {
        "ru": "📅 Дней для <b>{target}</b>?",
        "uz": "📅 <b>{target}</b> kun?",
        "en": "📅 Days for <b>{target}</b>?",
    },
    "vip_bulk_done": {
        "ru": "✅ <b>{target}</b> на <b>{days}</b> дн. ({count})",
        "uz": "✅ <b>{target}</b> <b>{days}</b> ({count})",
        "en": "✅ <b>{target}</b> for <b>{days}</b>d ({count})",
    },
    "inactive_nudge": {
        "ru": "💤 Давно тебя не было!\nНажми /start",
        "uz": "💤 Sizni ko'rmadik!\n/start bosing",
        "en": "💤 Long time no see!\nTap /start",
    },
    "moder_help": {
        "ru": (
            "ℹ️ <b>Помощь модера</b>\n"
            "🔨 Бан / Разбан\n"
            "📊 Статистика\n"
            "📤 Экспорт\n"
            "📢 Каналы\n\n"
    ...
    "sex_room_renamed": {
        "ru": "✏️ Переименована: <b>{title}</b>",
        "uz": "✏️ <b>{title}</b>",
        "en": "✏️ Renamed: <b>{title}</b>",
    },
    "sex_exit_requested": {
        "ru": "⏳ Запрос отправлен",
        "uz": "⏳ So'rov yuborildi",
    ...
    "sex_no_room": {
        "ru": "💬 Нет комнаты. /sex чтобы создать",
        "uz": "💬 Xona yo'q. /sex",
        "en": "💬 No room. /sex to create",
    },
    "sex_member_joined_you": {
        "ru": "👤 <b>{name}</b> присоединился (#{num})",
        "uz": "👤 <b>{name}</b> (#{num})",
        "en": "👤 <b>{name}</b> joined (#{num})",
    },
    "sex_msg_from": {
        "ru": "<b>💬 {num}:</b>",
        "uz": "<b>💬 {num}:</b>",
    ...
    "premium_active": {
        "ru": "✅ <b>Premium активен</b>\nдо {date}\n\n👇 Купить ещё:",
        "uz": "✅ <b>Premium faol</b>\n{date} gacha",
        "en": "✅ <b>Premium active</b>\nuntil {date}",
    },
    "premium_invoice_sent": {
        "ru": "💳 Счёт выставлен",
        "uz": "💳 Hisob-faktura",
        "en": "💳 Invoice sent",
    },
    "premium_paid": {
        "ru": "⭐ <b>Premium активирован!</b>\n+{months} мес.",
        "uz": "⭐ <b>Premium!</b>\n+{months} oy",
        "en": "⭐ <b>Premium activated!</b>\n+{months} months",
    },
    "premium_pkg_desc": {
        "ru": "Premium на {months} мес. ({days} дн.)",
        "uz": "Premium {months} oy",
        "en": "Premium for {months} months",
    },
    "reveal_next_btn_free": {
        "ru": "👁 Узнать · {n} БОНУС",
        "uz": "👁 · {n} BONUS",
        "en": "👁 Reveal · {n} FREE",
    },
    "reveal_next_btn_paid": {
        "ru": "👁 Узнать · {n} ⭐",
        "uz": "👁 · {n} ⭐",
        "en": "👁 Reveal · {n} ⭐",
    },
    "reveal_no_attempts": {
        "ru": "💎 Бесплатные кончились.\nКупить ещё?",
        "uz": "💎 Tugadi. Sotib olasizmi?",
        "en": "💎 Free attempts over. Buy more?",
    },
    "reveal_pack_title": {
        "ru": "👁 <b>Купить «Узнать»</b>\nСкидка растёт:",
        "uz": "👁 <b>«Aniqlash» sotib olish</b>",
        "en": "👁 <b>Buy «Reveal»</b>",
    },
    "reveal_pack_line": {
        "ru": "{n} шт — <b>{stars} ⭐</b> ({disc}%)",
        "uz": "{n} — <b>{stars} ⭐</b>",
        "en": "{n} pcs — <b>{stars} ⭐</b> ({disc}%)",
    },
    "reveal_pack_bought": {
        "ru": "✅ <b>{n} «Узнать»</b>\n−{stars} ⭐",
        "uz": "✅ <b>{n}</b>\n−{stars} ⭐",
    ...
    "liked_you_title": {
        "ru": "💕 <b>Вас лайкнули!</b>",
        "uz": "💕 <b>Layk qilishdi!</b>",
        "en": "💕 <b>Someone liked you!</b>",
    },
    "liked_you_info": {
        "ru": "👤 <b>{name}</b>, {age}\n📄 {bio}",
        "uz": "👤 <b>{name}</b>, {age}\n📄 {bio}",
    ...
    "liked_you_footer": {
        "ru": "👇 Ответь взаимно или пропусти:",
        "uz": "👇 O'zaro javob yoki o'tkazish:",
        "en": "👇 Reply or skip:",
    },
    "liked_no_photo": {
        "ru": "📷 <i>Нет фото</i>",
    ...
    "liked_reply_waiting": {
        "ru": "✅ <b>Ответил взаимно</b>\nЖдём второго…",
        "uz": "✅ <b>O'zaro</b>\nIkkinchisini kutamiz…",
        "en": "✅ <b>Replied back</b>\nWaiting for other…",
    },
    "mutual_title": {
        "ru": "💕 <b>Вы понравились друг другу!</b>",
        "uz": "💕 <b>Bir-biringizga!</b>",
        "en": "💕 <b>You liked each other!</b>",
    },
    "mutual_footer": {
        "ru": "👇 Подтверди знакомство:",
        "uz": "👇 Tasdiqlang:",
        "en": "👇 Confirm:",
    },
    "mutual_confirmed_one": {
        "ru": "✅ <b>Подтвердил</b>\nЖдём второго…",
        "uz": "✅ <b>Tasdiqlandi</b>\nKutamiz…",
        "en": "✅ <b>Confirmed</b>\nWaiting…",
    },
    ...
    "auto_hello": {
        "ru": "👋 Привет! Я <b>{name}</b>, из 𝐍𝐞𝐱𝐭.. — хочу познакомиться 😊",
        "uz": "👋 Salom! Men <b>{name}</b>, 𝐍𝐞𝐱𝐭.. — tanishmoqchiman 😊",
        "en": "👋 Hi! I'm <b>{name}</b>, from 𝐍𝐞𝐱𝐭.. — let's chat 😊",
    },
    "no_profiles_limit": {
        "ru": "😔 <b>Нет анкет</b>\nПопробуй позже",
        "uz": "😔 <b>Anketalar yo'q</b>",
        "en": "😔 <b>No profiles</b>",
    },
})
# ===================== БЛОК 6 / 14 — t() И КЛАВИАТУРЫ =====================
...
def main_menu_kb(tg_id):
    ...
    try:
        has_pkg = conn.execute(
            "SELECT 1 FROM star_packages WHERE active=1 LIMIT 1"
        ).fetchone()
        if has_pkg:
...
def share_kb(link, text):
    ...
    return InlineKeyboardMarkup(
        [[InlineKeyboardButton(t("btn_share"), url=share_url)]]
    )
...
def roulette_pref_reply_kb():
    return tr_kb(
        ReplyKeyboardMarkup(
            [
                [
                    KeyboardButton("👨 Парня"),
                    KeyboardButton("👩 Девушку"),
        ...
        [
            [
                InlineKeyboardButton(
                    tr_btn("💕 Ответить"),
                    callback_data=f"nlike_yes:{like_id}",
                )
            ],
            [
                InlineKeyboardButton(
                    tr_btn("💤 Игнорировать"),
                    callback_data=f"nlike_no:{like_id}",
                )
            ],
        ]
    )
...
def next_mutual_inline_kb(like_id, reveal_label=None):
    rows = [
        [
            InlineKeyboardButton(
                tr_btn("💕 Ответить"),
                callback_data=f"nmutual_yes:{like_id}",
            )
        ]
    ]
    if reveal_label:
        rows.append(
            [
                InlineKeyboardButton(
                    reveal_label,
                    callback_data=f"nreveal:{like_id}",
                )
            ]
        )
    rows.append(
        [
            InlineKeyboardButton(
                tr_btn("💤 Игнорировать"),
                callback_data=f"nmutual_no:{like_id}",
            )
        ]
    )
    ...
    return InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    reveal_label,
                    callback_data=f"nreveal_card:{target_id}",
                )
            ]
        ]
    )
    ...
    return InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    tr_btn("↩️ Ответить"),
                    callback_data=f"nreply:{mid}",
                )
            ],
            [
                InlineKeyboardButton(
                    tr_btn("🚩 Жалоба"),
                    callback_data=f"nreport:{mid}",
                )
            ],
        ]
    )
    ...
    for p in VIP_PACKAGES:
        rows.append(
            [
                InlineKeyboardButton(
                    f"⭐ {p['label']} — {p['stars']} ⭐",
                    callback_data=f"vipbuy:{p['months']}",
                )
            ]
        )
    return InlineKeyboardMarkup(rows)
    ...
    for p in REVEAL_PACKAGES:
        ...
        rows.append(
            [
                InlineKeyboardButton(
                    label,
                    callback_data=f"revbuy:{p['count']}",
                )
            ]
        )
    return InlineKeyboardMarkup(rows)
...
def ref_rewards_kb(uid, link=None):
    ...
    if link:
        ...
        share_url = (
            ...
            + "&text="
            + urllib.parse.quote(t("ref_share_text"), safe="")
        )
        rows.append(
            [
                InlineKeyboardButton(
    ...
    return tr_kb(
        ReplyKeyboardMarkup(
            [
                ...
                [
                    KeyboardButton("💰 Начислить коины"),
                    KeyboardButton("👑 VIP по ID"),
                ],
                [
...
def admin_moder_kb():
    return tr_kb(
        ReplyKeyboardMarkup(
            [
                [
                    KeyboardButton("➕ Выдать модера"),
                    KeyboardButton("➖ Забрать модера"),
                ],
                [KeyboardButton("⬅️ Назад"), KeyboardButton("🏠 Меню")],
            ],
            resize_keyboard=True,
...
def admin_vip_kb():
    return tr_kb(
        ReplyKeyboardMarkup(
            [
                [
                    KeyboardButton("👑 VIP всем"),
                    KeyboardButton("👑 VIP девушкам"),
                    KeyboardButton("👑 VIP парням"),
                ],
                [
                    KeyboardButton("➕ Выдать VIP"),
                    KeyboardButton("➖ Забрать VIP"),
                ],
                [KeyboardButton("⬅️ Назад"), KeyboardButton("🏠 Меню")],
            ],
            resize_keyboard=True,
...
def vip_bulk_menu_kb(bulk_filter):
    if bulk_filter == "all":
        give = "➕ Выдать VIP всем"
        take = "➖ Забрать у всех"
    elif bulk_filter == "female":
        give = "➕ Выдать VIP девушкам"
        take = "➖ Забрать у девушек"
    else:
        give = "➕ Выдать VIP парням"
        take = "➖ Забрать у парней"
    return tr_kb(
        ReplyKeyboardMarkup(
            [
...
def adm_channels_kb(uid=None):
    ...
    if uid is not None and is_admin(uid):
        ...
        if enabled:
            toggle = "Подписка для входа: ВКЛ"
        else:
            toggle = "Подписка для входа: ВЫКЛ"
    ...
    return InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    "Выдать",
                    callback_data=f"modapp:ok:{app_id}",
                ),
                InlineKeyboardButton(
                    "Отказ",
                    callback_data=f"modapp:no:{app_id}",
                ),
            ]
        ]
    )
...
def subscribe_kb(msg_id, channels):
    ...
    rows.append(
        [
            InlineKeyboardButton(
                t("btn_check_sub"),
                callback_data=f"subcheck:{msg_id}",
            )
        ]
    )
    return InlineKeyboardMarkup(rows)
...
def qualified_referrals(uid):
    row = conn.execute(
        ...
        "WHERE r.referrer_id=? AND r.active=1 "
        "AND u.custom_link IS NOT NULL",
        (uid,),
    ).fetchone()
...
def save_link_flow(user_id, target_id, state, msg_type=None):
    try:
        ...
        conn.execute(
            ...
            "(user_id, target_id, msg_type, state, updated_at) "
            "VALUES (?, ?, ?, ?, ?)",
...
def load_link_flow(user_id):
    try:
        row = conn.execute(
            "SELECT * FROM link_flow WHERE user_id=?",
            (user_id,),
        ).fetchone()
    except Exception:
        return None
...
def can_show_profile(viewer_id, target_id):
    try:
        week_ago = (
            now_dt() - timedelta(days=NEXT_REPEAT_WINDOW_DAYS)
        ).isoformat()
        row = conn.execute(
            "SELECT COUNT(*) c FROM nearby_shown "
            "WHERE viewer_id=? AND target_id=? AND shown_at>?",
            (viewer_id, target_id, week_ago),
        ).fetchone()
...
def mark_shown(viewer_id, target_id):
    try:
        conn.execute(
            "INSERT INTO nearby_shown "
            "(viewer_id, target_id, shown_at) "
            "VALUES (?, ?, ?)",
            (viewer_id, target_id, now_iso()),
        )
        conn.commit()
    except Exception as e:
        log.debug("mark_shown: %s", e)
...
def get_reveal_free_left(uid):
    ...
    try:
        row = conn.execute(
            "SELECT used FROM reveal_free_used "
...
def use_reveal_free(uid):
    ...
    try:
        row = conn.execute(
            "SELECT * FROM reveal_free_used "
            "WHERE user_id=? AND period=?",
            (uid, period),
        ).fetchone()
        if row:
            conn.execute(
                "UPDATE reveal_free_used SET used = used + 1 WHERE id=?",
                (row["id"],),
            )
        else:
            conn.execute(
                "INSERT INTO reveal_free_used "
                "(user_id, period, used) "
                "VALUES (?, ?, 1)",
                (uid, period),
            )
        ...
        log.warning("use_reveal_free: %s", e)


def get_reveal_paid_left(uid):
    try:
        row1 = conn.execute(
            "SELECT COALESCE(SUM(count),0) s FROM reveal_purchases "
            "WHERE user_id=? AND refunded=0",
            (uid,),
        ).fetchone()
        bought = row1["s"] if row1 else 0
        row2 = conn.execute(
            "SELECT COUNT(*) c FROM nearby_notifications "
            "WHERE user_id=? AND type='reveal_paid'",
            (uid,),
        ).fetchone()
        used = row2["c"] if row2 else 0
...
def register_notification(
    ...
    try:
        expires = (
            now_dt() + timedelta(days=NEXT_NOTIF_TTL_DAYS)
        ).isoformat()
        conn.execute(
            "INSERT INTO nearby_notifications "
            "(user_id, chat_id, message_id, type, target_id, "
            "like_id, expires_at, created_at) "
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
            (
                uid,
                chat_id,
        ...
        log.debug("register_notification: %s", e)
...
async def grant_daily_bonus(uid, context):
    ...
    try:
        ...
        await context.bot.send_message(
            uid,
            t("vip_daily_bonus", n=VIP_DAILY_BONUS),
            parse_mode="HTML",
        )
        set_cur_lang(_sl)
    except TelegramError as e:
...
def is_banned_pair(u1, u2):
    try:
        row = conn.execute(
            ...
            "((owner_id=? AND banned_id=?) "
            "OR (owner_id=? AND banned_id=?))",
            (now_iso(), u1, u2, u2, u1),
        ).fetchone()
...
def can_change_link(user_row):
    ...
    try:
        ...
        cooldown_end = last_change + timedelta(
            days=LINK_CHANGE_COOLDOWN_DAYS
        )
...
def user_is_disposable(uid):
    ...
    try:
        if conn.execute(
            "SELECT 1 FROM star_purchases WHERE user_id=? LIMIT 1",
            (uid,),
        ).fetchone():
            return False
        if conn.execute(
            "SELECT 1 FROM nearby_profiles WHERE user_id=? LIMIT 1",
            (uid,),
        ).fetchone():
            return False
        if conn.execute(
            "SELECT 1 FROM nearby_matches "
            "WHERE user1_id=? OR user2_id=? LIMIT 1",
            (uid, uid),
        ).fetchone():
            return False
        if conn.execute(
            "SELECT 1 FROM vip_purchases WHERE user_id=? LIMIT 1",
            (uid,),
        ).fetchone():
            return False
        if conn.execute(
            "SELECT 1 FROM reveal_purchases WHERE user_id=? LIMIT 1",
            (uid,),
        ).fetchone():
            return False
    except Exception:
...
def purge_user(uid, force=False):
    try:
        ...
        conn.execute(
            ...
            "WHERE referred_id=? OR referrer_id=?",
            (uid, uid),
        )
        ...
        conn.execute(
            "DELETE FROM nearby_matches "
            "WHERE user1_id=? OR user2_id=?",
            (uid, uid),
        )
        conn.execute(
            "DELETE FROM nearby_messages "
            "WHERE from_id=? OR to_id=?",
            (uid, uid),
        )
        conn.execute("DELETE FROM nearby_answers WHERE user_id=?", (uid,))
        conn.execute(
            "DELETE FROM nearby_shown "
            "WHERE viewer_id=? OR target_id=?",
            (uid, uid),
        )
        conn.execute(
            "DELETE FROM nearby_notifications WHERE user_id=?",
            (uid,),
        )
        ...
        conn.execute(
            "DELETE FROM anon_watchers "
            "WHERE mod_id=? OR target_id=?",
            (uid, uid),
        )
        conn.execute(
        ...
        if ref_id and ref_id != uid and get_user(ref_id):
            try:
                conn.execute(
                    ...
                    "(referrer_id, referred_id, coins_awarded, "
                    "active, created_at) "
                    "VALUES (?, ?, 0, 1, ?)",
                    (ref_id, uid, now_iso()),
                )
                ...
                if is_vip(ref_user):
                    bonus = REF_INVITED_BONUS_VIP
                else:
                    bonus = REF_INVITED_BONUS
                conn.execute(
...
async def _render_profile(uid):
    ...
    try:
        rows = conn.execute(
            "SELECT started_at, ended_at, active "
    ...
    try:
        rows = conn.execute(
            ...
            "WHERE active=1 GROUP BY referrer_id "
...
async def btn_change_gender(message: Message):
    ...
    await _reply(
        message,
        t("choose_new_gender"),
        reply_markup=gender_kb(with_back=True),
    )
...
async def _render_referral(uid):
    ...
    if u and is_vip(u):
        reward = REF_REWARD_VIP
    else:
        reward = REF_REWARD_NORMAL
    total = 0
    try:
        row = conn.execute(
            "SELECT COUNT(*) c FROM referrals "
    ...
    try:
        row = conn.execute(
            "SELECT COALESCE(SUM(coins_awarded),0) s "
        ...
        pass
    if u and is_vip(u):
        bonus = t("referral_bonus_vip")
    else:
        bonus = t("referral_bonus_normal")
    return t(
        "referral_screen",
        reward=reward,
        bonus=bonus,
...
async def btn_top_ref(message: Message):
    try:
        rows = conn.execute(
            ...
            "WHERE r.active=1 "
            "GROUP BY r.referrer_id, u.first_name, u.username "
    ...
    if state == "link_change" and old:
        conn.execute(
            ...
            (
                old,
                (
                    now_dt() + timedelta(hours=LINK_OLD_TTL_HOURS)
                ).isoformat(),
                uid,
            ),
        )
...
async def anon_type_question(message: Message):
    ...
    await _reply(
        message,
        t("anon_write_prompt", label=t("anon_label_question")),
        reply_markup=cancel_reply_kb(),
    )
...
async def anon_type_valentine(message: Message):
    ...
    await _reply(
        message,
        t("anon_write_prompt", label=t("anon_label_valentine")),
        reply_markup=cancel_reply_kb(),
    )


async def _send_anon_to_target(
    bot,
    from_id,
    target_id,
    msg_type,
    ...
    if msg_type == "question":
        hdr_key = "anon_hdr_question"
    else:
        hdr_key = "anon_hdr_valentine"
    ...
    owner_mid = 0
    if sent:
        owner_mid = sent.message_id

    mid = None
    try:
        cur = conn.execute(
            "INSERT INTO anon_messages "
            "(from_id, to_id, msg_type, content_type, text, "
            "voice_file_id, owner_chat_message_id, "
            "answered, deleted, created_at) "
            "VALUES (?, ?, ?, ?, ?, ?, ?, 0, 0, ?)",
            (
                from_id,
                target_id,
            ...
            kb = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            t("btn_reply"),
                            callback_data=f"areply:{mid}",
                        ),
                        InlineKeyboardButton(
                            t("btn_report"),
                            callback_data=f"areport:{mid}",
                        ),
                    ],
                    [
                        InlineKeyboardButton(
                            t("btn_reveal"),
                            callback_data=f"areveal:{mid}",
                        ),
                        InlineKeyboardButton(
                            t("btn_delete"),
                            callback_data=f"adel:{mid}",
                        ),
                    ],
                ]
            )
...
async def _do_anon_reply(message, uid, parent_id, voice_file_id=None):
    parent = conn.execute(
        "SELECT * FROM anon_messages WHERE id=?",
        (parent_id,),
    ).fetchone()
    ...
    try:
        conn.execute(
            "INSERT INTO anon_messages "
            "(from_id, to_id, msg_type, content_type, text, "
            "voice_file_id, parent_id, owner_chat_message_id, "
            "answered, deleted, created_at) "
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?, 1, 0, ?)",
            (
                uid,
...
async def handle_text_router(message: Message):
    ...
    if state == "set_gender_first":
        ...
        if g:
            ...
            await _reply(
                message,
                t("gender_saved", g=gender_label(g)),
                reply_markup=main_menu_kb(uid),
            )
        else:
            await _reply(
    ...
    if state == "gift_id":
        ...
        await _reply(
            message,
            t("giftcoins_ask_amount", balance=u["coins"] or 0),
            reply_markup=cancel_reply_kb(),
        )
        return
    ...
    if state == "gift_amount":
        ...
        await _reply(
            message,
            t("giftcoins_sent", amount=amt, id=target),
            reply_markup=profile_kb(),
        )
        try:
            _sl = cur_lang()
...
async def _relay_roulette(message, session):
    ...
    if session["user1_id"] == uid:
        other = session["user2_id"]
    else:
        other = session["user1_id"]
...
async def _roulette_join(message, pref):
    ...
    if not u or not u["gender"]:
        return
    conn.execute(
        "UPDATE users SET search_pref=? WHERE tg_id=?",
        (pref, uid),
    )
    conn.commit()
...
async def btn_stop_session(message: Message):
    ...
    if not sess:
        ...
        return
    if sess["user1_id"] == uid:
        other = sess["user2_id"]
    else:
        other = sess["user1_id"]
    conn.execute(
        "UPDATE roulette_sessions "
        "SET active=0, ended_at=?, ended_by=? WHERE id=?",
        (now_iso(), uid, sess["id"]),
    )
    conn.commit()
    UD[uid]["state"] = None
...
async def btn_next_main(message: Message):
    uid = message.from_user.id
    prof = conn.execute(
        "SELECT * FROM nearby_profiles WHERE user_id=?",
        (uid,),
    ).fetchone()
    UD[uid]["state"] = None
    if not prof:
        ...
        await _reply(
            message,
            t("next_create_title") + t("next_ask_name"),
...
async def next_like(message: Message):
    ...
    try:
        ...
        conn.execute(
            "INSERT INTO nearby_likes "
            "(from_id, to_id, action, created_at) "
            "VALUES (?, ?, 'like', ?)",
            (uid, target, now_iso()),
        )
        conn.commit()
...
async def _handle_mutual_like(bot, u1, u2):
    ...
    for a, b in ((u1, u2), (u2, u1)):
        try:
            ...
            txt = (
                f"{t('match_final_title')}\n"
                f"{info}\n\n"
                f"{t('match_final_footer')}"
            )
            set_cur_lang(_sl)
...
async def cb_like_yes(cq: CallbackQuery):
    ...
    try:
        ...
        return
    like = conn.execute(
        "SELECT * FROM nearby_likes WHERE id=?",
        (like_id,),
    ).fetchone()
    if not like:
...
@dp.message(F.text, lambda m: (
    UD[m.from_user.id].get("state") or ""
).startswith("next_create_"))
async def next_create_flow(message: Message):
    ...
    if state == "next_edit_name":
        if not (2 <= len(text) <= 30):
            ...
            return
        conn.execute(
            "UPDATE nearby_profiles SET name=?, updated_at=? "
            "WHERE user_id=?",
            (text, now_iso(), uid),
        )
        conn.commit()
    ...
    if state == "next_edit_age":
        if not text.isdigit() or not (12 <= int(text) <= 99):
            ...
            return
        conn.execute(
            "UPDATE nearby_profiles SET age=?, updated_at=? "
            "WHERE user_id=?",
    ...
    if state == "next_edit_bio":
        if not (5 <= len(text) <= 200):
            ...
            return
        conn.execute(
            "UPDATE nearby_profiles SET bio=?, updated_at=? "
            "WHERE user_id=?",
            (text, now_iso(), uid),
        )
        conn.commit()
    ...
    if state == "next_edit_gender":
        ...
        if not g:
            ...
            return
        conn.execute(
            "UPDATE nearby_profiles SET gender=?, updated_at=? "
            "WHERE user_id=?",
            (g, now_iso(), uid),
        )
        conn.commit()
    ...
    if state == "next_edit_looking":
        ...
        if not lk:
            ...
            return
        conn.execute(
            "UPDATE nearby_profiles SET looking_for=?, updated_at=? "
            "WHERE user_id=?",
            (lk, now_iso(), uid),
        )
        conn.commit()
...
@dp.message(
    F.photo,
    lambda m: UD[m.from_user.id].get("state") == "next_create_photo",
)
async def next_create_photo(message: Message):
    ...
    try:
        existing = conn.execute(
            "SELECT 1 FROM nearby_profiles WHERE user_id=?",
            (uid,),
        ).fetchone()
        if existing:
            conn.execute(
                "UPDATE nearby_profiles SET name=?, age=?, "
                "gender=?, looking_for=?, bio=?, photo_id=?, "
                "active=1, updated_at=? WHERE user_id=?",
                (
                    d.get("name"),
                    d.get("age"),
                    d.get("gender"),
            ...
            conn.execute(
                ...
                "(user_id, name, age, gender, looking_for, "
                "bio, photo_id, active, created_at) "
                "VALUES (?, ?, ?, ?, ?, ?, ?, 1, ?)",
                (
                    uid,
                    d.get("name"),
...
@dp.message(
    F.photo,
    lambda m: UD[m.from_user.id].get("state") == "next_edit_photo",
)
async def next_edit_photo_save(message: Message):
    ...
    try:
        conn.execute(
            "UPDATE nearby_profiles SET photo_id=?, updated_at=? "
            "WHERE user_id=?",
...
async def cb_next_reply(cq: CallbackQuery):
    ...
    try:
        ...
        return
    msg = conn.execute(
        "SELECT * FROM nearby_messages WHERE id=?",
        (mid,),
    ).fetchone()
    if not msg:
...
async def btn_export_users(message: Message):
    ...
    try:
        rows = conn.execute(
            ...
            "coins, vip_until, created_at FROM users"
        ).fetchall()
    except Exception:
        rows = []
    lines = [
        "tg_id | username | first_name | gender | age | "
    ...
    try:
        await message.bot.send_document(
            uid,
            BufferedInputFile(data, filename="users.txt"),
...
async def btn_vip_all(message: Message):
    ...
    await _reply(
        message,
        t("vip_bulk_menu_title", target="👥 всем"),
...
async def btn_vip_girls(message: Message):
    ...
    await _reply(
        message,
        t("vip_bulk_menu_title", target="👩 девушкам"),
...
async def btn_vip_guys(message: Message):
    ...
    await _reply(
        message,
        t("vip_bulk_menu_title", target="👨 парням"),
...
async def btn_vip_bulk_grant(message: Message):
    ...
    await _reply(
        message,
        t("vip_bulk_ask_days", target=names[bulk_filter]),
        reply_markup=cancel_reply_kb(),
    )
...
async def btn_vip_bulk_revoke(message: Message):
    ...
    try:
        ...
        conn.commit()
        row = conn.execute(
            f"SELECT COUNT(*) c FROM users {where}"
        ).fetchone()
        if row:
            cnt = row["c"]
    except Exception as e:
...
async def bcast_all(message: Message):
    ...
    if not is_admin(uid):
        return
    if UD[uid].get("state") != "adm_bcast_audience":
        return
...
@dp.message(
    F.text,
    lambda m: UD[m.from_user.id].get("state") == "adm_bcast_text",
)
async def bcast_send(message: Message):
    ...
    try:
        rows = conn.execute(
            f"SELECT tg_id FROM users {where}",
            tuple(params),
        ).fetchall()
    except Exception:
        rows = []
...
async def btn_del_channel(message: Message):
    ...
    for i, c in enumerate(chans, 1):
        lines.append(
            f"{i}. {channel_title(c)} — {c['chat_username']}"
        )
    await _reply(
        message,
        "\n".join(lines),
...
@dp.message(
    F.text,
    lambda m: UD[m.from_user.id].get("state") == "adm_channel_add",
)
...
@dp.message(
    F.text,
    lambda m: UD[m.from_user.id].get("state") == "adm_channel_del",
)
...
async def btn_refund_stars(message: Message):
    ...
    await _reply(
        message,
        "⭐ Введите ID пользователя для возврата:",
        reply_markup=cancel_reply_kb(),
    )
...
async def adm_state_router(message: Message):
    ...
    if state == "adm_coins_amount":
        ...
        await _reply(
            message,
            f"✅ Начислено {amt} пользователю {tgt}",
            reply_markup=admin_menu_kb(),
        )
        return
    ...
    if state == "adm_vip_grant_days":
        ...
        tgt = UD[uid]["adm_target"]
        until = (
            now_dt() + timedelta(days=days)
        ).isoformat()
        conn.execute(
            "UPDATE users SET vip_until=? WHERE tg_id=?",
            (until, tgt),
        )
        conn.commit()
        UD[uid]["state"] = None
        await _reply(
            message,
            t("vip_granted_admin", id=tgt, days=days),
            reply_markup=admin_vip_kb(),
        )
        try:
            _sl = cur_lang()
    ...
    if state == "adm_vip_revoke_id":
        ...
        if not target:
            ...
            return
        conn.execute(
            "UPDATE users SET vip_until=NULL WHERE tg_id=?",
            (target,),
        )
        conn.commit()
        UD[uid]["state"] = None
    ...
    if state.startswith("adm_vip_bulk_days:"):
        ...
        try:
            conn.execute(
                f"UPDATE users SET vip_until=? {where}",
                (until,),
            )
            conn.commit()
            row = conn.execute(
    ...
    if state == "adm_moder_grant_id":
        ...
        if not target:
            ...
            return
        conn.execute(
            "UPDATE users SET is_moder=1 WHERE tg_id=?",
            (target,),
        )
        conn.commit()
        UD[uid]["state"] = None
    ...
    if state == "adm_moder_revoke_id":
        ...
        if not target:
            ...
            return
        conn.execute(
            "UPDATE users SET is_moder=0, moder_until=NULL "
            "WHERE tg_id=?",
            (target,),
        )
        conn.commit()
    ...
    if state == "adm_pkg_stars":
        ...
        try:
            conn.execute(
                ...
                "(title, coins, price_stars, active) "
                "VALUES (?, ?, ?, 1)",
    ...
    if state == "adm_pkg_del":
        ...
        pid = int(check)
        conn.execute(
            "DELETE FROM star_packages WHERE id=?",
            (pid,),
        )
        conn.commit()
        UD[uid]["state"] = None
    ...
    if state == "adm_refund":
            ...
            for r in rows:
                try:
                    conn.execute(
                        ...
                        "SET refunded=1, refunded_at=? WHERE id=?",
                        (now_iso(), r["id"]),
                    )
                    conn.execute(
                        "UPDATE users "
                        "SET coins = MAX(0, coins - ?) WHERE tg_id=?",
                        (r["coins"], target),
                    )
                    refunded += r["stars"]
                except Exception:
        ...
        await _reply(
            message,
            f"✅ Возврат выполнен. Всего звёзд: {refunded}",
            reply_markup=admin_menu_kb(),
        )
        return
        # ===================== БЛОК 13 / 14 — МАГАЗИН, STARS, PREMIUM =====================
...
async def btn_shop(message: Message):
    ...
    u = get_user(uid)
    items = conn.execute(
        "SELECT * FROM shop_items WHERE active=1"
    ).fetchall()
    if not items:
        await _reply(
            message,
    ...
    for it in items:
        ...
        rows.append(
            [KeyboardButton(f"{item_title(it)} · {price}💰")]
        )
    rows.append([KeyboardButton("⬅️ Назад")])
...
@dp.message(
    F.text,
    lambda m: UD[m.from_user.id].get("state") == "shop_browse",
)
async def shop_buy_handler(message: Message):
    ...
    if rtype == "coins":
        ...
        await _reply(
            message,
            t("purchase_vip", days=days),
            reply_markup=main_menu_kb(uid),
        )
    else:
        try:
            conn.execute(
                "INSERT INTO moder_apps "
                "(user_id, item_id, price_paid, status, created_at) "
                "VALUES (?, ?, ?, 'pending', ?)",
                (uid, target["id"], price, now_iso()),
            )
            conn.commit()
            row = conn.execute(
                "SELECT id FROM moder_apps "
    ...
    try:
        conn.execute(
            ...
            "(user_id, item_id, price_paid, created_at) "
            "VALUES (?, ?, ?, ?)",
            (uid, target["id"], price, now_iso()),
        )
        conn.commit()
...
async def btn_buy_coins(message: Message):
    uid = message.from_user.id
    pkgs = conn.execute(
        "SELECT * FROM star_packages WHERE active=1"
    ).fetchall()
    if not pkgs:
        await _reply(
            message,
...
@dp.message(
    F.text,
    lambda m: UD[m.from_user.id].get("state") == "stars_browse",
)
...
async def btn_premium(message: Message):
    ...
    if is_vip(u) and not is_admin(uid):
        try:
            ...
            await _reply(
                message,
                t("premium_active", date=date_str),
...
@dp.message(
    F.text,
    lambda m: any(
        (m.text or "").startswith(f"{p['count']} шт")
        for p in REVEAL_PACKAGES
    ),
)
...
async def cmd_sex(message: Message):
    ...
    if not is_staff(uid):
        ...
        return
    room = conn.execute(
        "SELECT * FROM sex_rooms ORDER BY id DESC LIMIT 1"
    ).fetchone()
    if room:
        await _reply(
            message,
...
@dp.message(
    F.text,
    lambda m: UD[m.from_user.id].get("state") == "sex_create_title",
)
async def sex_create_title(message: Message):
    ...
    try:
        ...
        if not rid:
            row = conn.execute(
                "SELECT id FROM sex_rooms "
                "ORDER BY id DESC LIMIT 1"
            ).fetchone()
            if row:
                rid = row["id"]
        girls = conn.execute(
            "SELECT tg_id FROM users WHERE gender='f'"
        ).fetchall()
        for i, g in enumerate(girls, 1):
            try:
                conn.execute(
                    "INSERT INTO sex_members "
                    "(room_id, user_id, role, number, joined_at) "
                    "VALUES (?, ?, 'member', ?, ?)",
...
def _sex_user_room(uid):
    try:
        return conn.execute(
            "SELECT * FROM sex_members WHERE user_id=?",
            (uid,),
        ).fetchone()
    except Exception:
        return None
    ...
    try:
        if message.voice:
            conn.execute(
                ...
                "(room_id, sender_number, content_type, "
                "voice_file_id, created_at) "
                "VALUES (?, ?, 'voice', ?, ?)",
        ...
        pass
    others = conn.execute(
        "SELECT user_id, number FROM sex_members "
...
@dp.message(
    F.text,
    lambda m: UD[m.from_user.id].get("state") == "watch_anon_id",
)
async def anon_watch_handle(message: Message):
    ...
    for m in reversed(msgs):
        lines.append(
            f"[{m['created_at']}] {m['from_id']} → "
            f"{m['to_id']} ({m['content_type']}): "
            f"{m['text'] or ''}"
        )
    data = "\n".join(lines).encode("utf-8")
    try:
        conn.execute(
            "INSERT INTO anon_watchers "
            "(mod_id, target_id, active, created_at) "
            "VALUES (?, ?, 1, ?)",
            (uid, target, now_iso()),
        )
        conn.commit()
...
async def cmd_next_admin(message: Message, command: CommandObject):
    ...
    if not args:
        await _reply(
            message,
            "Использование: /next <user_id> <текст>",
        )
        return
...
async def cmd_tg_monitor(message: Message):
    ...
    # ===================== БЛОК 14 / 14 — ИНЛАЙН, ПЛАТЕЖИ, ФОН, ENTRY =====================
...
async def cb_anon_report(cq: CallbackQuery):
    ...
    try:
        cur = conn.execute(
            "INSERT INTO reports "
            "(reporter_id, reported_id, context, ref_id, "
            "status, created_at) "
            "VALUES (?, ?, 'anon', ?, 'pending', ?)",
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    t("🔨 Бан"),
                    callback_data=f"rep:ban:{rid}",
                ),
                InlineKeyboardButton(
                    t("❌ Отклонить"),
                    callback_data=f"rep:no:{rid}",
                ),
            ]
        ]
    )
    ...
    for adm in ADMIN_IDS:
        try:
            await cq.bot.send_message(
                ...
                f"👤 От: {rep_mention}\n"
                f"🎯 На: {from_mention}\n"
                f"📝 Контекст: {html.escape(text200)}",
                reply_markup=kb,
            )
        except TelegramError:
            pass
...
async def cb_anon_delete(cq: CallbackQuery):
    ...
    try:
        conn.execute(
            "UPDATE anon_messages SET deleted=1 WHERE id=?",
            (pid,),
        )
        conn.commit()
    except Exception:
    ...
    if ok_other:
        try:
            ...
            await cq.bot.send_message(
                other,
                t("anon_deleted_notice"),
            )
            set_cur_lang(_sl)
        except TelegramError:
            pass
    if ok_other:
        await cq.answer(t("del_both"))
    else:
        await cq.answer(t("del_only_me"))
...
async def cb_claim_vip(cq: CallbackQuery):
    ...
    conn.execute(
        "UPDATE users SET ref_vip_claims = ref_vip_claims + 1 "
        "WHERE tg_id=?",
        (uid,),
    )
    conn.commit()
    await cq.answer(
        t("ref_vip_granted", days=days),
        show_alert=True,
    )
...
async def cb_claim_moder(cq: CallbackQuery):
    ...
    until = (now_dt() + timedelta(days=days)).isoformat()
    conn.execute(
        "UPDATE users SET moder_until=? WHERE tg_id=?",
        (until, uid),
    )
    conn.execute(
        "UPDATE users SET ref_moder_claims = ref_moder_claims + 1 "
        "WHERE tg_id=?",
        (uid,),
    )
    conn.commit()
    await cq.answer(
        t("ref_moder_granted", days=days, need=need),
        show_alert=True,
    )
...
async def cb_modapp(cq: CallbackQuery):
    ...
    try:
        ...
        return
    app = conn.execute(
        "SELECT * FROM moder_apps WHERE id=?",
        (aid,),
    ).fetchone()
    ...
    if action == "ok":
        conn.execute(
            "UPDATE moder_apps SET status='approved' WHERE id=?",
            (aid,),
        )
        conn.execute(
            "UPDATE users SET is_moder=1 WHERE tg_id=?",
        ...
        conn.execute(
            "UPDATE moder_apps SET status='rejected' WHERE id=?",
            (aid,),
        )
        conn.execute(
            "UPDATE users SET coins = coins + ? WHERE tg_id=?",
...
async def cb_report_decision(cq: CallbackQuery):
    ...
    if action == "ban":
        ...
        try:
            conn.execute(
                "INSERT INTO bans "
                "(owner_id, banned_id, until, created_at) "
                "VALUES (?, ?, ?, ?)",
                (
                    rep["reporter_id"],
                    reported,
...
async def on_successful_payment(message: Message):
    ...
    if payload.startswith("starpkg:"):
        try:
            ...
            return
        pkg = conn.execute(
            "SELECT * FROM star_packages WHERE id=?",
            (pid,),
        ).fetchone()
        if not pkg:
            await _reply(
        ...
        try:
            conn.execute(
                ...
                "(user_id, package_id, coins, stars, "
        ...
        if u and u["vip_until"]:
            try:
                existing = datetime.fromisoformat(u["vip_until"])
                if existing > base:
                    base = existing
            except Exception:
                pass
        until = (
            base + timedelta(days=months * 30)
        ).isoformat()
        conn.execute(
            "UPDATE users SET vip_until=? WHERE tg_id=?",
            (until, uid),
        ...
        try:
            ...
            conn.execute(
                "INSERT INTO nearby_notifications "
                "(user_id, chat_id, message_id, type, "
                "target_id, expires_at, created_at) "
                "VALUES (?, ?, 0, 'reveal_paid', ?, ?, ?)",
                (uid, uid, tid, expires, now_iso()),
            )
            conn.commit()
        except Exception:
            pass
...
async def _janitor_loop():
    while True:
        try:
            ...
            try:
                cutoff = (
                    now_dt() - timedelta(days=INACTIVE_DAYS)
                ).isoformat()
                rows = conn.execute(
                    "SELECT tg_id FROM users "
            ...
            try:
                conn.execute(
                    "UPDATE users "
                    "SET old_link=NULL, old_link_until=NULL "
                    "WHERE old_link_until IS NOT NULL "
                    "AND old_link_until<?",
                    (now_iso(),),
                )
                conn.commit()
...
async def _inactive_nudge_loop():
    while True:
        try:
            ...
            nudge_cutoff = (
                now_dt() - timedelta(days=JANITOR_PERIOD_DAYS)
            ).isoformat()
            rows = conn.execute(
                "SELECT tg_id FROM users "
                "WHERE (last_active IS NULL OR last_active<?) "
...
def init_default_data():
    try:
        has_pkg = conn.execute(
            "SELECT 1 FROM star_packages LIMIT 1"
        ).fetchone()
        if not has_pkg:
            packs = [
                ("50 коинов", 50, 50),
        ...
        if not has_item:
            items = [
                ...
                (
                    "Заявка на модера",
                    "Подать заявку на роль модератора",
                    500,
                    0,
                    None,
                    "manual",
            ...
            for ttl, dsc, price, is_vip, days, rt, amt in items:
                conn.execute(
                    ...
                    "(title, description, price, is_vip, "
                    "duration_days, reward_type, reward_amount, "
                    "active) "
                    "VALUES (?, ?, ?, ?, ?, ?, ?, 1)",
...
if __name__ == "__main__":
    try:
        ...
        boot.critical(
            "Конфликт: запущено два экземпляра бота? %s",
            e,
        )
        raise SystemExit(1)
    except Exception as e:
