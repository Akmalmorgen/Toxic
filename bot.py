...
T.update({
    ...
    "subgate_start": {
        "ru": "🔒 <b>Подпишись чтобы пользоваться</b>\n━━━━━━━━━━━━━━━━━━━━\nНажми кнопку → подпишись → «Проверить»",
        "uz": "🔒 <b>Obuna bo'ling</b>",
    ...
    "reveal_result_next": {
        ...
        "uz": "👁 <b>Kim layk qildi:</b>\n👤 <b>{name}</b>, {age}\n💬 {bio}\n\n🔗 <a href=\"tg://user?id={tid}\">{uname_or_link}</a>",
        "en": "👁 <b>Who liked you:</b>\n👤 <b>{name}</b>, {age}\n💬 {bio}\n\n🔗 <a href=\"tg://user?id={tid}\">{uname_or_link}</a>",
    },
    "liked_you_title": {
        "ru": "💕 <b>Вас лайкнули!</b>",
...
async def adm_state_router(message: Message):
    ...
    if state == "adm_refund":
        ...
        return
        # ===================== БЛОК 13 / 14 — МАГАЗИН, STARS, PREMIUM, /sex, /anon =====================
...
# ===================== ФИНАЛЬНАЯ РЕГИСТРАЦИЯ РОУТЕРА =====================
# handle_text_router регистрируем ПОСЛЕДНИМ — он ловит всё, что не поймали
# узкие фильтры выше (кнопки меню, стейт-машина и т.д.)
...
def main():
    """Синхронная точка входа — совместимо с main.py: from bot import main; main()."""
    try:
