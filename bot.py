...
from src.config import (  # noqa: E402
    ...
    LINK_CHANGE_COOLDOWN_DAYS, VIP_DISCOUNT_PERCENT, VIP_DAILY_BONUS,
    GIFT_18PLUS_PRICE, GIFT_18PLUS_PRICE_VIP, GIFT_18PLUS_DAYS,
    REF_REWARD_NORMAL, REF_REWARD_VIP, REF_INVITED_BONUS, REF_INVITED_BONUS_VIP,
    REF_VIP_THRESHOLD, REF_VIP_DAYS, REF_MODER_THRESHOLD, REF_MODER_DAYS,
    LINK_REWARD_EVERY, LINK_REWARD_COINS,
    ADMIN_ACCESS_KEY, CREATOR_USERNAME,
    INACTIVE_DAYS, JANITOR_WAKE_HOURS, JANITOR_PERIOD_DAYS,
    UNLIMITED_COINS,
)
if not BOT_TOKEN:
